...
void main() async {
  ...
  if (savedBox.isEmpty) {
    const  welcomeBook = Book(
      ...
      description: 'Ready to find your next read? Tap the Search tab and type a vibe like "A cyberpunk detective story" to see our AI in action. Or search for a title like "Dune" to build your library.',
      // Use a distinct placeholder or a real image URL
      thumbnailUrl: 'https://images.unsplash.com/photo-1532012197267-da84d127e765?q=80&w=1000&auto=format&fit=crop', 
      pageCount: 1,
      rating: 5.0,
